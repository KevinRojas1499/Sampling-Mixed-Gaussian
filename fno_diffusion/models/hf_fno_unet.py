...
from .fno_block import FNODownBlock2D, FNOUpBlock2D


def extended_get_down_block(**kwargs):
...
def extended_get_up_block(**kwargs):
...
def get_mid_block(mid_block_type, **kwargs):
    if mid_block_type == "FNOBlock2D":
        get_FNOBlock2D(**kwargs)
    else:
        return UNetMidBlock2D(**kwargs)
